...
\textit{[Tabla 1. Distribución demográfica de riesgo y dependencia del sistema público en Tucumán (basado en \cite{ref12})]}
...
\textit{[Tabla 2. Registro histórico del pico de crisis multi epidémica en Tucumán (valores de referencia basados en \cite{ref13})]}
...
\textit{[Tabla 3. Indicadores clínicos de severidad y requerimientos asistenciales (basado en \cite{ref14, ref15})]}
